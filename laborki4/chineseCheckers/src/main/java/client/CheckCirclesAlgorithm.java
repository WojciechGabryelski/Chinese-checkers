...
public abstract class CheckCirclesAlgorithm {
    ...
    /**
     * Sets the color of checkers which are checked before running this algorithm.
     */
    ...
    /**
     * Sets the number of circles adjacent to one side of the star.
     */
