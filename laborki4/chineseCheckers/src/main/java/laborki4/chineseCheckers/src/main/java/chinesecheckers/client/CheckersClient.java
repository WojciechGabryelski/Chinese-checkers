...
public class CheckersClient {
     ...
     * @return true if game is not finished and false otherwise.
     * @throws Exception
     */
    ...
    public void setColors(int num, int id) {
        ...
        Color[] colors = {Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW, Color.ORANGE, Color.BLACK};
        for (int k = 0; k < 6; k++) {
        ...
        switch (num) {
        case 2:
            this.color = colors[3 * id];
            break;
        case 3:
            this.color = colors[2 * id];
            break;
        case 4:
            this.color = colors[id % 2 + id / 2 * 3];
            break;
        case 6:
